...
* **Encrypted, incremental, chunk-based backups to S3** So no third party can access my prsonal data, i dont have to upload lots of date more than once can can freely choose the storage provider.
